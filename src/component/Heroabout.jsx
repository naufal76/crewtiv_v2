...
import gambar from '../assets/crewtiv.jpg'
...
const Heroabout = () => {
  return (
    ...
    <div className='lg:flex items-center justify-center  py-36'>
    <div className='w-1/2 flex items-center justify-center' >
        <img src={gambar} alt=""className='h-96 justify-center'/>
    </div>
    <div className='w-1/2'>
        <h1 className='font-medium text-4xl flex py-5'>
            Who Am I?
        </h1>
